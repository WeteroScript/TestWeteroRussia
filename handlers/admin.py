        ...
        try:
            ...
            if current_bidder and current_bid > 0:
                ...
                if current_bidder in users:
                    ...
                    # Добавляем деньги на баланс (если они уже были списаны)
                    # В auction.py деньги списываются только при победе, так что просто размораживаем
                    await save_users(users)

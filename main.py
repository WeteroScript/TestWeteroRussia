...
async def main():
    ...
    register_handlers(dp)              # из core/handlers.py
    register_admin_handlers(dp)        # из handlers/admin.py
    register_business_handlers(dp)     # из handlers/business.py
    register_user_handlers(dp)         # из handlers/user.py
